          ...
          <b-card-group>
            ...
            <b-card no-body class="text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <b-card-body class="text-center">
                <div>
                  <h2>Sistema DOPSA</h2>
                  <p>Sistema de administración de Grupo Dopsa.</p>
                  <p>Si no tienes permiso para estar en esta página o ser parte de Grupo Dopsa favor de cerrar el navegador.</p>
                </div>
              </b-card-body>
            </b-card>
          </b-card-group>
